...
let kWhsSources = document.querySelector('#kWh-sources');
kWhsSources.style.fontSize = '12px';

let consumptionSources = document.querySelector('#consumption-sources');
consumptionSources.style.fontSize = '12px';

let carbonPpm = document.querySelector('#carbon-ppm');
carbonPpm.style.fontSize = '17px';

let genByBill = document.querySelector('#gen-by-bill');
genByBill.style.fontSize = '18.5px';
